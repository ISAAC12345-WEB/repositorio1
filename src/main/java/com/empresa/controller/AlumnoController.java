...
public class AlumnoController {
	...
	@PostMapping
	@ResponseBody
	public ResponseEntity<Alumno> registraAlumno(@RequestBody Alumno obj){//@RequestBody permite datos en json
	...
	public ResponseEntity<Alumno> actualizaAlumno(@RequestBody Alumno obj){
		...
		Optional<Alumno> optAlumno = service.buscaPorId(obj.getIdAlumno());
			...
			Alumno objActualizado=service.insertaActualiza(obj);
